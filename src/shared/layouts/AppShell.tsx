import { Bell, Brain, CalendarDays, CheckSquare, GraduationCap, Home, Menu, Search, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen overflow-hidden text-foreground">
      <div className="mx-auto flex min-h-screen w-full max-w-[1500px]">
        <aside className="hidden w-72 shrink-0 border-r border-white/10 bg-vault-ink/55 px-5 py-6 backdrop-blur-2xl lg:block">
          <Logo />
          ...
          <div className="mt-8 rounded-xl border border-vault-mint/20 bg-vault-mint/10 p-4">
            ...
            <Button className="mt-4 w-full" size="sm">Nova entrada</Button>
          </div>
        </aside>

        <main className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 border-b border-white/10 bg-background/78 px-4 py-3 backdrop-blur-2xl sm:px-6">
          ...
          <nav className="safe-bottom fixed inset-x-0 bottom-0 z-30 border-t border-white/10 bg-vault-ink/90 px-2 py-2 backdrop-blur-2xl lg:hidden">

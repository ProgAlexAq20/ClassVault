...
create index if not exists lessons_classroom_idx on public.lessons (classroom_id);
create index if not exists files_classroom_idx on public.files (classroom_id, created_at desc);
create index if not exists notes_classroom_idx on public.notes (classroom_id, created_at desc);
create index if not exists tasks_classroom_idx on public.tasks (classroom_id, created_at desc);
create index if not exists events_user_starts_idx on public.events (user_id, starts_at);
create index if not exists summaries_classroom_idx on public.summaries (classroom_id, created_at desc);
...
create policy "lessons_select_own" on public.lessons
  for select using (public.owns_classroom(classroom_id));
create policy "lessons_insert_own" on public.lessons
  for insert with check (public.owns_classroom(classroom_id));
create policy "lessons_update_own" on public.lessons
  for update using (public.owns_classroom(classroom_id)) with check (public.owns_classroom(classroom_id));
create policy "lessons_delete_own" on public.lessons
  for delete using (public.owns_classroom(classroom_id));
